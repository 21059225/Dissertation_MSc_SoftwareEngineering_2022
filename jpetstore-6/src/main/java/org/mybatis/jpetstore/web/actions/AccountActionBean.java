...
public class AccountActionBean extends AbstractActionBean {
    ...
    public Resolution newAccount(){
        ...
        account.setSessionId(uuid.toString());
        accountService.insertAccount(account);
        account = accountService.getAccount(account.getUsername(),account.getSessionId());
        myList = catalogService.getProductListByCategory(account.getFavouriteCategoryId(),account.getSessionId());
        authenticated = true;
    ...
    public Resolution signon(){
        ...
        MONITORING_CONTROLLER.newMonitoringRecord(e);
        account.setSessionId(uuid.toString());
        account = accountService.getAccount(getUsername(), getPassword(),account.getSessionId());
