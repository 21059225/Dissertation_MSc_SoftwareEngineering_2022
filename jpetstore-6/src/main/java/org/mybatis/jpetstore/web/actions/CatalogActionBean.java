...
public class CatalogActionBean extends AbstractActionBean {
    ...
    public ForwardResolution viewCategory(){
        ...
        if (categoryId != null){
            productList = catalogService.getProductListByCategory(categoryId,uuid.toString());
            category = catalogService.getCategory(categoryId,uuid.toString());
        }
    ...
    public ForwardResolution viewProduct(){
        ...
        MONITORING_CONTROLLER.newMonitoringRecord(e);
        if (productId != null){
            itemList = catalogService.getItemListByProduct(productId,uuid.toString());
            product = catalogService.getProduct(productId,uuid.toString());
        }
    ...
    public ForwardResolution viewItem(){
        ...
        final OperationExecutionRecord e = new OperationExecutionRecord(
                ...
                1);
        MONITORING_CONTROLLER.newMonitoringRecord(e);
        item = catalogService.getItem(itemId,uuid.toString());
    ...
    public ForwardResolution searchProducts(){
        ...
        if (keyword == null || keyword.length() < 1){
            ...
            productList = catalogService.searchProductList(keyword.toLowerCase(),uuid.toString());
